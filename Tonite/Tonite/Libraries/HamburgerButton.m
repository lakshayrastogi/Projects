...
- (instancetype)initWithFrame:(CGRect)frame lineWidth:(CGFloat)lineWidth lineHeight:(CGFloat)lineHeight lineSpacing:(CGFloat)lineSpacing lineCenter:(CGPoint)lineCenter color:(UIColor *)color {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        [self setUpHamburgerWithlineWidth:lineWidth
...
- (void)setUpHamburgerWithlineWidth:(CGFloat)lineWidth lineHeight:(CGFloat)lineHeight lineSpacing:(CGFloat)lineSpacing lineCenter:(CGPoint)lineCenter color:(UIColor *)color {
