...
//#define IS_IPHONE_6_PLUS_AND_ABOVE ( [[UIScreen mainScreen] nativeScale] > 2.1 ) ? YES : NO

#define IS_IPHONE_6_PLUS_AND_ABOVE ( [UIScreen mainScreen].bounds.size.height >= 667.0 ) ? YES : NO
